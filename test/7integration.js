...
//   });
//
//   describe('ChangeMaker clone', async () => {
...
//   describe('Project', () => {
//     describe('Ownership', () => {
//       it('owner(): Owner of changeMaker clone is the project owner', async () => {
//         const { interface } = await ethers.getContractFactory('Project');
//         org2projectClone1 = new ethers.Contract(
//           projectClone1Address,
//           interface,
//           organization2
//         );
//
//         expect(await org2projectClone1.owner()).to.not.equal(organization2.address);
//         expect(await org2projectClone1.owner()).to.equal(organization1.address);
//       });
//     });
//
//     describe('Refund', () => {
//       it('refund(): only changeDao owner can refund', async () => {
//         await expect(org2projectClone1.refund()).to.be.reverted;
//       });
//
//       it('refund(): changeDao refunds sponsors', async () => {
//         const { interface } = await ethers.getContractFactory('Project');
//         cdProjectClone1 = new ethers.Contract(
//           projectClone1Address,
//           interface,
//           changeDaoOwner
//         );
//         // Change the assertions for this test after refund() is fully written
//         await expect(cdProjectClone1.refund()).to.not.be.reverted;
//       })
//     });
//
//     describe('Withdraw', () => {
//       it('withdrawChangemakerShare(): only changemaker can withdraw', async () => {
//         const { interface } = await ethers.getContractFactory('Project');
//         org1projectClone1 = new ethers.Contract(
//           projectClone1Address,
//           interface,
//           organization1
//         );
//
//         await expect(org2projectClone1.withdrawChangemakerShare()).to.be.reverted;
//         await expect(org1projectClone1.withdrawChangemakerShare()).to.not.be.reverted;
//       });
//
//       it('withdrawChangemakerShare(): ', async () => {
//
//       });
//
//       it('withdrawChangeDaoShare(): only changedao can withdraw', async () => {
//         await expect(org2projectClone1.withdrawChangeDaoShare()).to.be.reverted;
//         await expect(cdProjectClone1.withdrawChangeDaoShare()).to.not.be.reverted;
//       });
//
//       it('withdrawChangeDaoShare(): ', async () => {
//         await expect(org2projectClone1.withdrawChangeDaoShare()).to.be.reverted;
//         await expect(cdProjectClone1.withdrawChangeDaoShare()).to.not.be.reverted;
//       });
//
//       it('withdrawCommunityFundShare(): only changedao can withdraw', async () => {
//
//       });
//
//       it('withdrawCommunityFundShare(): ', async () => {
//
//       });
//     });
//   });
